      ...
      >
        ...
        <div className="flex items-center justify-center h-full">
            <div className="border-4 border-white rounded-full flex-col flex w-64 h-64 pt-7">
              ...
              <h1 className='text-4xl text-white  m-5 font-Allura'>Reja & Evi</h1>
              <span className="text-sm text-white font-bold ">Kepada YTH</span>
                <span className="text-sm text-white font-bold ">{nama}</span>
